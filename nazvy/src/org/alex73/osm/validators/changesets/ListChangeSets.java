...
public class ListChangeSets {
    ...
    public static void main(String[] args) throws Exception {
        ...
        VelocityOutput.output("org/alex73/osm/validators/changesets/changes.velocity", out, "changes", changes);
    }
    ...
    static byte[] get(String apiCall) throws Exception {
        ...
        if (conn.getResponseCode() != 200) {
            throw new IOException("Call " + apiCall + ": " + conn.getResponseCode() + " " + conn.getResponseMessage());
        }
        try {
