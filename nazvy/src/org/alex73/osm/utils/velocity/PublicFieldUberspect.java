 ...
 *
 * <p>
 * To use, tell Velocity to use this class for introspection by adding the following to your
 * velocity.properties:<br />
 *
 * <code>
...
public class PublicFieldUberspect extends UberspectImpl {
    ...
    /**
     * Property getter - returns VelPropertyGet appropos for #set($foo = $bar.woogie). <br />
     * Returns a special {@link VelPropertyGet} for the <code>length</code> property of arrays. Otherwise
     * tries the regular routine. If a getter was not found, returns a {@link VelPropertyGet} that gets from
     * public fields.
     *
     * @param obj
     *            the object
    ...
    /**
     * Property setter - returns VelPropertySet appropos for #set($foo.bar = "geir"). <br />
     * First tries the regular routine. If a setter was not found, returns a {@link VelPropertySet} that sets
     * to public fields.
     *
     * @param obj
     *            the object
