 ...
 *       &lt;attribute name="osmTypes" use="required" type="{http://www.w3.org/2001/XMLSchema}string" />
 *       &lt;attribute name="geometryType" use="required" type="{}GeometryType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlRootElement(name = "check_geometry")
public class CheckGeometry {

    protected List<Tag> filter;
    @XmlAttribute(name = "message", required = true)
    protected String message;
    @XmlAttribute(name = "osmTypes", required = true)
    protected String osmTypes;
    @XmlAttribute(name = "geometryType", required = true)
