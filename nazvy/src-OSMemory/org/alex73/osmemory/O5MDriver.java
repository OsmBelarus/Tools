...
import ru.dkiselev.osm.o5mreader.O5MReader.UnexpectedEndOfFileException;
...
public class O5MDriver {
    ...
    public O5MDriver(O5MReaderMy handler) {
     ...
     */
    static final long readUnsignedNumberAbsolute() {
        // long value = 0;
        // long b = 0x80;
        //
    ...
    String getObjectTagValueString(int pos) {
        return getString(objectTagValuePositions[pos], objectTagValueSizes[pos]);
    }
